...
//		if(string.contains(String.valueOf( root.nodeName))) return cyclomaticComplexity;
...
//				newNode = buildChild(newNode, true);
...
//				}
//
//				if(lines.get(lineNo).contains("}")) return statement_node;
//
//			}
//		lineNo++;
//		}
